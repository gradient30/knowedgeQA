...
- Backend full regression: `python -m pytest tests/ --cov=app -q` -> 63 passed, 71% coverage, warning-free.
...
| Backend full regression | `python -m pytest tests/ --cov=app -q` | Passed: 63 tests, 71% coverage, warning-free. |
